...
/***/ function(module, exports, __webpack_require__) {
	...
	// Require Components
	var Info = __webpack_require__(161);
	...
	var Main = React.createClass({
	  ...
	  handleSearchSummoner: function handleSearchSummoner(e) {
	    e.preventDefault();
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'header',
	        null,
	        'Basic React League of Legends App'
	      ),
	      React.createElement(
	        'form',
	        { onSubmit: this.handleSearchSummoner },
	        React.createElement('input', { type: 'text', placeholder: 'Search for a summoner name', ref: 'search' })
	      ),
	      React.createElement(Info, { summonerName: this.state.summonerName })
	    );
	  }
	});
